...
import DEFAULT_IMAGE from "./assets/images/symptoms/defaultSymptomImage.jpg";

// function ProductModal({ onClose, onSelectProduct, onSelectProduct2 }) {
function NewSymptomModal({
  productsLocal = [],
  productsServer = [],
          ...
          {productsLocal.map((product, index) => (
            ...
            >
              ...
              <img
                ...
                onClick={() => {
                  onSelectProduct2({ ...product, type: "symptom" });
                  onClose();
                }}
              />
              <p>{product.name}</p>
